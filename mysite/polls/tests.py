...
def create_question(question_text, days):
	# creates a question w/ the given 'question_text' and published the given number of 'days' offset to now
...
class QuestionViewTests(TestCase):
	def test_index_view_with_no_questions(self):
		# If no questions exist, then an appropriate message should be displayed
	...
	def test_index_with_a_past_question(self):
		# Questions w/ a pub_date in the past should be displayed on the index page.
	...
	def test_index_with_a_future_question(self):
		#Questions w/ a pub_date in the future should not be displayed on the index page.
...
class QuestionIndexDetailTests(TestCase):
	def test_detail_view_with_a_future_question(self):
		# The detail view of a question w/ a pub_date in the future should return a 404 not found.
	...
	def test_detail_view_with_a_past_question(self):
		# The detail view of a question w/ a pub_date in the past should display the question's text.
